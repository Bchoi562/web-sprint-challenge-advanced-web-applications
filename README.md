...
1. Explain what a token is used for.
    A token is used to have an individual key for each user associated with the website. Basically, to save a users authenticated state.
2. What steps can you take in your web apps to keep your data secure?
    Use things like private route and token.
3. Describe how web servers work.
    a combination of code and hardware to create web apps and pages.
4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
    PUT maps to both Create and Update depending on the fact that URI used with the PUT exists.
    POST maps to Create.
